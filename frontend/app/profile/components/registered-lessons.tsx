...
export function RegisteredLessons({
  ...
  const handleRegisterLesson = (lessonId: string, isRegistered: boolean) => {
    if (isRegistered) {
      onUnregister(lessonId);
    }
    handleCloseModal();
  };
    ...
    <>
      ...
      {selectedLesson && (
        <LessonDetailModal
          ...
          isRegistered={true} // All lessons in this component are registered
